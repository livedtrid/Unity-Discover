...
namespace MRComputer.Scripts
{
    public class ComputerVisibleObject : NetworkBehaviour
    {
        ...
        [SerializeField] private ComputerNetworkEvent m_networkEvent;
        ...
        [Networked(OnChanged = nameof(OnRotatorGrabbedChanged))]
        private bool RotatorGrabbed { get; set; }

        [Networked(OnChanged = nameof(OnAffordanceChanged))]
        private bool AffordanceActive { get; set; }
        ...
        private void OnTriggerRPC()
        {
            if (m_networkEvent == null)
            {
                ...
                m_networkEvent = m_visiblePart.GetComponent<ComputerNetworkEvent>();
            }
